local icons = require "nvchad.icons"
...
local options = {
  ...
  on_attach = function(bufnr)
    ...
    map("n", "<leader>hj", gs.next_hunk, opts "Next Hunk")
    map("n", "<leader>hk", gs.prev_hunk, opts "Prev Hunk")
    map("n", "<leader>hb", function()
      gs.blame_line { full = true }
    end, opts "Blame Line")
    map("n", "<leader>hB", gs.toggle_current_line_blame, opts "Toggle blame")
    map("n", "<leader>hd", gs.diffthis, opts "Diffthis")
    map("n", "<leader>hD", function() gs.diffthis "~" end, opts "Diff Head")
